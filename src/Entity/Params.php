...
namespace Evrinoma\Delta8Bundle\Entity;
 ...
 * Params
 *
 * @ORM\Table(name="PARAMS", indexes={
 *     @ORM\Index(name="IDX_7F36C9759497FC04", columns={"SCALEID"}),
 *     @ORM\Index(name="IDX_7F36C975FE08514F", columns={"DEVICEID"}),
 *     @ORM\Index(name="IDX_7F36C975EBD84B70", columns={"SCRIPT_ENGINE_ID"}),
 *     @ORM\Index(name="IDX_7F36C97547405208", columns={"GROUPID"})}
 *     )
 * @ORM\Entity
